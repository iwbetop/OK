...
import { SelectReport } from "@/components/user/selectReport";
import { auth } from "@/auth";
import { SendReportBackend } from "@/actions/user/report";
    ...
    return(
      <div className="space-y-4 relative">
        ...
        <CardContent>
            <div>
                {user?.skill.map(item => (
                    <span className="inline-flex items-center relative bg-secondary text-secondary-foreground p-2 rounded mx-2">
                        {item.skill.name}
                    </span>
                ))}
                {user?.skill.length === 0 && (
                        ...
                        <div className="flex justify-between items-center px-2">
                            <div className="flex gap-3">
                                ...
                                <div>
                                    <h3>{item.name}</h3>
                                    <span className="text-muted-foreground text-sm">
                                        <span>{item.dateCompleted.toDateString()}</span>
                                    </span>
                        ...
                        <div className="flex justify-between items-center px-2">
                            <div className="flex gap-3">
                                ...
                                <div className="">
                                    ...
                                    <span className="bg-primary text-primary-foreground px-1 rounded text-sm">{item.category}</span>
                                </div>
                            </div>
                        </div>
                    </div>
