...
import { Textarea } from "@/components/ui/textarea";
  ...
  export default async function Achievement(){
    ...
    const userSpecialAchievement = user?.achievements.filter((item) => item.category === "SPECIAL")

    return(
        <Card className="relative">
        <CardHeader>
            <CardTitle>Manage Achievement</CardTitle>
            <CardDescription>Customize your special achievement achievement</CardDescription>
        </CardHeader>
        <CardContent>
            <div>
