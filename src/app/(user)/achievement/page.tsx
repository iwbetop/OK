...
import { Textarea } from "@/components/ui/textarea";
  ...
  export default async function Achievement(){
    ...
    const userNormalAchievement = user?.achievements.filter((item) => item.category === "ACADEMIC")

    return(
        <Card className="relative">
        <CardHeader>
            <CardTitle>Manage Achievement</CardTitle>
            <CardDescription>Customize your academic achievement achievement</CardDescription>
        </CardHeader>
        <CardContent>
            <div>
                {userNormalAchievement && userNormalAchievement.map(item => (
                ...
                {userNormalAchievement && userNormalAchievement.length! === 0 && (
