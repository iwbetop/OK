...
export default auth((req) => {
  ...
  const isAdminPage = nextUrl.pathname.startsWith(adminRoute) || extendedAdminRoute.includes(nextUrl.pathname) || nextUrl.pathname.startsWith("/superadmin");
  ...
  switch (user.role) {
    ...
    case "ADMIN":
      ...
      break;
    case "USER":
      if (!user.onbordedStatus && !nextUrl.pathname.startsWith("/onboard")) {
